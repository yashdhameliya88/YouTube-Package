        ...
        <div class="container mx-auto flex px-5 py-2 md:flex-row flex-col items-center">
            ...
            <div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
                ...
                <form action="login.php" method="POST" style="padding: 25px;" onsubmit="return validateForm()">
                    ...
                    <center><button type="submit" value="Login" class="text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg" style="width: 100%;">Login</button>
                    <br><br>
                    <a href="forgotpass.php" style="cursor: pointer; text-decoration: none; color: blue;" onmouseover="this.style.textDecoration='underline'; this.style.color='blue'" onmouseout="this.style.textDecoration='none'; this.style.color='blue'">Forgotten Password?</a>
                    <a href="">|</a>
